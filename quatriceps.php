...
function quatriceps_plugin_admin_init()
{
  ...
  add_settings_field('quatriceps_id', 'Quatriceps Numeric ID (optional)', 'quatriceps_setting_string', 'quatriceps', 'quatriceps_options');
  add_settings_field('quatriceps_router', 'Quatriceps Router', 'quatriceps_setting_router', 'quatriceps', 'quatriceps_options');
  add_settings_field('quatriceps_recaptcha_publickey', 'Recaptcha Public Key (optional)', 'quatriceps_setting_recaptcha_publickey', 'quatriceps', 'quatriceps_recaptcha_options');
  add_settings_field('quatriceps_recaptcha_privatekey', 'Recaptcha Private Key (optional)', 'quatriceps_setting_recaptcha_privatekey', 'quatriceps', 'quatriceps_recaptcha_options');
...
function quatriceps_script_enqueuer() {
  ...
  wp_register_script("recaptcha_script", "https://www.google.com/recaptcha/api/js/recaptcha_ajax.js", array(), '1.1.3', false);
